    ...
    <main className="app-shell reports-page">
      <header className="page-header">
        <div>
          ...
          <p className="page-description">Acompanhe as solicitações de relatórios semanais.</p>
        </div>
        <Button onClick={generateReport} isLoading={isGenerating}><span aria-hidden="true">＋</span> Solicitar relatório</Button>
      </header>
      ...
      <Card className="reports-intro-card" padding="lg">
        ...
        <div><p className="eyebrow">Relatórios semanais</p><h2>Seu histórico, em perspectiva.</h2><p>A solicitação cria um registro na fila. A geração do conteúdo ainda depende de um serviço de processamento.</p></div>
      </Card>
